...
System.out.println(joinStrings(new String[]{"Java", "is", "fun"}, "-")); // "Java-is-fun"System.out.println();
...
System.out.println(reverseWords("Java programming is fun")); // "avaJ gnimmargorp sinuf"
...
System.out.println(insertSpaceAfterNChars("ABCDEFGHIJKLMNOPQR", 4)); // "ABCDEFGH IJKL MNOP QR"
System.out.println(insertSpaceAfterNChars("programming", 3)); // "pro gra mmi ng"
}
/**
* 1. Check if a string is a palindrome, ignoring case and non-alphanumeric
characters.
*/
